...
Для визуализации результатов этого запроса я использовала линейный график, чтобы показать динамику. Использованы оттенки зеленого цвета для представления положительных изменений и устойчивого роста. Главный акцент сделан на общем изменении спроса во времени, поэтому не задействованы другие цвета.

https://datawrapper.dwcdn.net/mCl1v/2/
...
Для визуализации результатов этого запроса я использовала столбчатую диаграмму. Каждый столбец соответствует одной ценовой категории, длина каждого столбца отражает количество товаров в этой категории. Так как в данной столбчатой диаграмме представлена единая информация о количестве товаров, был использован один  цвет. Для акцентного выделения категорий с наибольшим количеством товаров был использован более темный тон выбранного цвета.
